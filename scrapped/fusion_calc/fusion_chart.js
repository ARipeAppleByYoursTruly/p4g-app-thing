...
$(function(){
  ...
  $('#switchJH').click(function(){
    $('th, td').each(function(){
      switch($(this).html()){
        case 'Jester':
          $(this).html('Hunger');
          $('#switchJH').html('Switch to Jester');
          break;
        
        case 'Hunger':
          $(this).html('Jester');
          $('#switchJH').html('Switch to Hunger');
          break;
  ...
  $('#hide_showFChart').click(function(){
    $('#switchJH, table, #clearSelection').toggle();
    
    switch($(this).html()){
      case 'Show Fusion Chart':
        $(this).html('Hide Fusion Chart');
        break;
      
      case 'Hide Fusion Chart':
        $(this).html('Show Fusion Chart');
        break;
